          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {p.why.cards.map((card, i) => (
              <FadeIn key={i} delay={i * 0.08}>
                <div className="flex flex-col min-h-[220px] bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-gold/30 hover:bg-white/[0.08] transition-all duration-300 cursor-pointer hover:scale-[1.02]">
